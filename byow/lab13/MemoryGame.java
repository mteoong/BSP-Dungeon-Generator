...
public class MemoryGame {
    ...
    public static void main(String[] args) {
        MemoryGame x = new MemoryGame(50, 50, 1);
        x.startGame();
        //x.flashSequence(x.generateRandomString(4));
...
//        game.startGame();
    ...
    public String generateRandomString(int n) {
        ...
        String randomString = "";
        for (int i = 0; i < n; i++) {
            randomString += Character.toString(generateRandomChar());
        }
        return randomString;
    }
    ...
    private char generateRandomChar() {
        rand = new Random();
        return CHARACTERS[rand.nextInt(26)];
    }
    ...
    public void startGame() {
        ...
        while (!gameOver) {
            ...
            StdDraw.pause(1000);
            gameOver = !input.equals(generated);
        }
